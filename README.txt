...
Note: Although my colleague initiated the process of automating this task at Valeo, I developed this tool independently and implemented it in my way for my purpose.

Finally, it can be developed using a simple algorithm (to make the process faster) and Google Workspace tools like Spreadsheet and AppScript.
